    ...
    <div className="d-flex" style={{ height: '100vh'}}>
      ...
      <div className="card shadow-sm card-body p-2 mb-3 mt-2" style={{ height: '7vh', width: '100%', display: 'flex' }}>
          <div>
            ...
            <h6 style={{ display: 'inline-block', margin: 1 }}> Danh sách dịch vụ</h6>
          </div>
        </div>
          <div className="card shadow-sm card-body">
            <div className="d-flex justify-content-between align-items-center ">
              ...
              <div className="card p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  />
                  <div className="mr-2">
                    <label className="mr-2 m-2">Trạng thái:</label>
            ...
            <div className="table-responsive table-container card">
